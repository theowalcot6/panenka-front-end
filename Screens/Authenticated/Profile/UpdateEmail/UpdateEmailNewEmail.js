...
export default function UpdateEmailNewEmail({navigation}) {
  ...
  const handleNext = async () => {
    ...
    if (isValidEmail(email)) {
      navigation.navigate('UpdateEmailVerification', { email: email });
      try {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Please enter your new email and we'll send you a code</Text>
      <TextInput
        style={styles.input}
        placeholder="Email"
